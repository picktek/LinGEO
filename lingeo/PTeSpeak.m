...
- (void)speak:(NSString*)text
{
    ...
    OSStatus err = AudioQueueNewOutput(&streamFormat, PTeSpeakAudioEngineOutputBufferCallback, (__bridge void * _Nullable)(self), CFRunLoopGetCurrent(), kCFRunLoopCommonModes, 0, &outputQueue);
    if (err != noErr) {

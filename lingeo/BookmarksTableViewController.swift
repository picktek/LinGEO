...
class BookmarksTableViewController: UITableViewController, NSFetchedResultsControllerDelegate {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        configureCell(cell, withBookmark: event)
        return cell
    }
    ...
    func configureCell(_ cell: UITableViewCell, withBookmark bookmark: Bookmarks) {
        cell.textLabel!.text = bookmark.eng
        cell.detailTextLabel!.text = bookmark.geo
    }
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "showDetail" {
            if let indexPath = tableView.indexPathForSelectedRow {
                ...
                controller.detailItemID = String(row.eng_id)
            }
        }
    }
    ...
    func controller(_ controller: NSFetchedResultsController<NSFetchRequestResult>, didChange anObject: Any, at indexPath: IndexPath?, for type: NSFetchedResultsChangeType, newIndexPath: IndexPath?) {
        ...
        case .update:
            configureCell(tableView.cellForRow(at: indexPath!)!, withBookmark: anObject as! Bookmarks)
        case .move:
            configureCell(tableView.cellForRow(at: indexPath!)!, withBookmark: anObject as! Bookmarks)
